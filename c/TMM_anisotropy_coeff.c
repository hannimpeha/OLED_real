...
Complex** TMM_anisotropy_coeffs_compinpv_w(double**** index, int no_EML, double** thick, Complex* inplane_vector, int ipv, int l_length, double wavelength, int i)	//	���Ҽ� ���� inplane vector�� ���庰 ���� ���
{
	//	input & output
	//	index : l*5*w matrix, refractive index
	//	thick : l vector, thickness of the layer
